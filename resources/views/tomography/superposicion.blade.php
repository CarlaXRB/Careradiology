...
<div class="flex justify-end">
    <a href="{{ route('tomography.show', ['id' => $tomography->id]) }}" class="botton1">Atrás</a>
</div>
<div class="container">
    <h1 class="txt-title2">SUPERPOSICION</h1>
    ...
    <div style="display: flex; justify-content: center; margin-top: 20px; margin-bottom: 20px;">
        <button id="autoOverlayButton" class="botton2">Superposición automática desactivada</button>
    </div>
</div>
