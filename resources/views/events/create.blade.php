...
<form method="POST" action="{{ route('events.store') }}">
    ...
    <div class="text-gray-900 dark:text-white">
        ...
        <div class="flex items-center mb-4">
            ...
            <input type="datetime-local" name="start_date" value="{{ old('start_date') }}" class="border-gray-300 dark:border-gray-600 rounded-lg p-2 w-full text-black dark:text-black focus:outline-none focus:ring-2 focus:ring-cyan-500 mr-10"/>
        </div>
        ...
        <div class="flex items-center mb-4">
            ...
            <input type="number" name="duration_minutes" id="duration_minutes" min="1" required value="{{ old('duration_minutes') }}" class="border-gray-300 dark:border-gray-600 rounded-lg p-2 w-full text-black dark:text-black focus:outline-none focus:ring-2 focus:ring-cyan-500 mr-10">
        </div>
        ...
        <div class="flex items-center mb-4">
            ...
            <select name="room" id="room" class="form-select border-gray-300 dark:border-gray-400 text-black dark:text-black rounded-lg p-2 mt-2 w-full focus:outline-none focus:ring-2 focus:ring-cyan-500 mr-10" required>
                <option value="" class="text-black">Seleccione una sala</option>
        ...
        <div class="flex items-center mb-4">
            ...
            <input type="text" name="event" value="{{ old('event') }}" class="border-gray-300 dark:border-gray-600 rounded-lg p-2 w-full text-black dark:text-black focus:outline-none focus:ring-2 focus:ring-cyan-500 mr-10"/>
        </div>
        @error('event') <p class="error">{{ $message }}</p> @enderror

        <div class="flex items-center mb-4">
            <label class="txt1">Detalles:</label>
            <input type="text" name="details" value="{{ old('details') }}" class="border-gray-300 dark:border-gray-600 rounded-lg p-2 w-full text-black dark:text-black focus:outline-none focus:ring-2 focus:ring-cyan-500 mr-10"/>    
        </div>
