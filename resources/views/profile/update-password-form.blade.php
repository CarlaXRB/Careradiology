<x-form-section submit="updatePassword">
    <x-slot name="title">
        {{ __('views.Update Password') }}
    </x-slot>

    <x-slot name="description">
        {{ __('views.Ensure your account is using a long, random password to stay secure.') }}
    </x-slot>

    <x-slot name="form">
        <div class="col-span-6 sm:col-span-4">
            <x-label for="current_password" value="{{ __('views.Current Password') }}" />
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="password" value="{{ __('views.New Password') }}" />
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="password_confirmation" value="{{ __('views.Confirm Password') }}" />
