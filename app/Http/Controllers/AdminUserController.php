...
class AdminUserController extends Controller
{
    ...
    public function data(){
        ...
        return view('dashboard.data', compact(
            'totalUsers','totalPatients','totalEvents','totalRadiographies','totalTomographies','totalReports','monthlyPatients','monthlyEvents','monthlyRadiographies','monthlyTomographies','monthlyReports','monthlyUsers','monthlyData'
        ));
    }   
}
